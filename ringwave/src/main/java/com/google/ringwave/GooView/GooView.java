package com.google.ringwave.GooView;
...
import com.google.ringwave.utils.GeometryUtil;
import com.google.ringwave.utils.Utils;
...
public class GooView extends View {
    ...
    private ShapeDrawable drawGooView() {
        ...
        PointF[] dragPoints = GeometryUtil.getIntersectionPoints(mDragCenter, dragCircleRadius,
                dragLineK);
        PointF[] stickPoints = GeometryUtil.getIntersectionPoints(mStickCenter,
				stickCircleTempRadius, dragLineK);
    ...
    private float getCurrentRadius(float distance) {
        ...
        float evaluateValue = (float) GeometryUtil.evaluateValue(fraction, stickCircleRadius,
				stickCircleMinRadius);
        ...
        if (isOutOfRange) {
            ...
            mAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    PointF pointByPercent = GeometryUtil.getPointByPercent(startPoint, endPoint,
							fraction);
