...
public final class g implements HttpClient {
    ...
    private class a implements HttpRequestInterceptor {
        ...
        public void process(HttpRequest request, HttpContext context) throws HttpException, IOException {
            ...
            if (configuration != null && configuration.a() && (request instanceof HttpUriRequest)) {
                configuration.a(g.b((HttpUriRequest) request, false));
            }
        }
    }
    ...
    private static g a(String userAgent, Context context, int timeOut, boolean redirecting) {
        ...
        return new g(new ThreadSafeClientConnManager(params, schemeRegistry), params);
    }

    public static g a(String userAgent, int timeOut) {
        return a(userAgent, null, timeOut, false);
    }

    public static g b(String userAgent, int timeOut) {
        return a(userAgent, null, timeOut, true);
    }

    private g(ClientConnectionManager ccm, HttpParams params) {
        this.c = new DefaultHttpClient(this, ccm, params) {
            final /* synthetic */ g a;

            protected BasicHttpProcessor createHttpProcessor() {
                BasicHttpProcessor processor = super.createHttpProcessor();
                processor.addRequestInterceptor(g.b);
