...
import com.qq.demo.ui.drawable.CircularAnimatedDrawable;
import com.qq.demo.ui.drawable.CircularProgressDrawable;
import com.qq.demo.ui.drawable.StrokeGradientDrawable;
...
public class CircularProgressButton extends Button {
    ...
    public CircularProgressButton(Context context, AttributeSet attributeSet, int defStyleRes) {
    ...
    private int getDisabledColor(ColorStateList colorStateList) {
        return colorStateList.getColorForState(new int[]{}, 0);
    }
    ...
    private StrokeGradientDrawable createDrawable(int color, int strokeColor) {
        GradientDrawable gradientDrawable = (GradientDrawable) getResources()
                .getDrawable(R.drawable.mc_cir_pro_btn_background).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray a = getTypedArray(context, attributeSet, R.styleable.CircularProgressButton);
        if (a != null) {
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.CircularProgressButton_strokeWidth, (int) getContext().getResources().getDimension(R.dimen
                            .mc_cir_progress_button_stroke_width));
            mIdleText = a.getString(R.styleable.CircularProgressButton_textIdle);
            mCompleteText = a.getString(R.styleable.CircularProgressButton_textComplete);
            mErrorText = a.getString(R.styleable.CircularProgressButton_textError);
            mProgressText = a.getString(R.styleable.CircularProgressButton_textProgress);
            mIconComplete = a.getResourceId(R.styleable.CircularProgressButton_iconComplete, 0);
            mIconError = a.getResourceId(R.styleable.CircularProgressButton_iconError, 0);
            mCornerRadius = a.getDimension(R.styleable.CircularProgressButton_cornerRadius, 0.0f);
            mPaddingProgress = a.getDimensionPixelSize(R.styleable.CircularProgressButton_paddingProgress, 0);

            int blue = getColor(R.color.cir_progress_button_blue);
            int white = getColor(R.color.cir_progress_button_white);
            int grey = getColor(R.color.cir_progress_button_grey);

            int idleStateSelector = a.getResourceId(R.styleable.CircularProgressButton_selectorIdle,
                    R.color.cir_progress_button_blue);
            mIdleColorState = getResources().getColorStateList(idleStateSelector);
            mStrokeColorIdle = getResources().getColorStateList(a.getResourceId(
                    R.styleable.CircularProgressButton_strokeColorIdle, idleStateSelector));
            int completeStateSelector = a.getResourceId(R.styleable.CircularProgressButton_selectorComplete,
                    R.color.cir_progress_button_green);
            mCompleteColorState = getResources().getColorStateList(completeStateSelector);
            mStrokeColorComplete = getResources().getColorStateList(a.getResourceId(
                    R.styleable.CircularProgressButton_strokeColorComplete, completeStateSelector));
            int errorStateSelector = a.getResourceId(R.styleable.CircularProgressButton_selectorError,
                    R.color.cir_progress_button_red);
            mErrorColorState = getResources().getColorStateList(errorStateSelector);
            mStrokeColorError = getResources().getColorStateList(a.getResourceId(
                    R.styleable.CircularProgressButton_strokeColorError, errorStateSelector));
            mColorProgress = a.getColor(R.styleable.CircularProgressButton_colorProgress, white);
            mColorIndicator = a.getColor(R.styleable.CircularProgressButton_colorIndicator, blue);
            mColorIndicatorBackground = a.getColor(R.styleable.CircularProgressButton_colorIndicatorBackground, grey);
            mTextColorError = a.getColorStateList(R.styleable.CircularProgressButton_textColorWrong);
            if (mTextColorError == null) {
                mTextColorError = getTextColors();
            }
            mTextColorIdle = a.getColorStateList(R.styleable
                    .CircularProgressButton_textColorIdle);
            if (mTextColorIdle == null) {
                mTextColorIdle = getTextColors();
            }
            mTextColorComplete = a.getColorStateList(R.styleable
    ...
    private void morphCompleteToIdle() {
        ...
        animation.setFromStrokeColor(getNormalColor(mStrokeColorComplete));
        animation.setToStrokeColor(getNormalColor(mStrokeColorIdle));
    ...
    private void morphErrorToIdle() {
        ...
        animation.setToColor(getNormalColor(mIdleColorState));
        animation.setFromStrokeColor(getNormalColor(mStrokeColorError));
        animation.setToStrokeColor(getNormalColor(mStrokeColorIdle));
        animation.setListener(mIdleStateListener);
        setState(State.IDLE);
        mCurrentStateDrawable = mIdleStateDrawable;
    ...
    private void morphIdleToError() {
        ...
        animation.setFromStrokeColor(getNormalColor(mStrokeColorIdle));
        animation.setToStrokeColor(getNormalColor(mStrokeColorError));
    ...
    private void morphProgressToError() {
        MorphingAnimation animation = createProgressMorphing((float) getHeight(),
                mCornerRadius, getHeight(), getWidth());
    ...
    public void setProgressCenterIcon(Drawable centerIcon) {
        mProgressCenterIcon = centerIcon;
