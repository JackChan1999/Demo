...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        mRingWidth = typedArray.getDimension(R.styleable.LoadingView_mcRingWidth, 4.5f);
        mBackgroundColor = typedArray.getColor(R.styleable.LoadingView_mcLBackground, mThemeColor);
        mForegroundColor = typedArray.getColor(R.styleable.LoadingView_mcLForeground, mThemeColor);
        mLoadingState = typedArray.getInt(R.styleable.LoadingView_mcLoadingState, 1);
        typedArray.recycle();
