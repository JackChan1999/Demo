...
public  class BaseHolder extends RecyclerView.ViewHolder {
    ...
    public BaseHolder(Context context, View itemView, ViewGroup parent, int position) {
        super(itemView);
        mPosition = position;
        mContext = context;
    ...
    public static BaseHolder get(Context context, View convertView,
                                 ViewGroup parent, int layoutId, int position) {
        if (convertView == null) {
            View itemView = LayoutInflater.from(context).inflate(layoutId,
                    parent, false);
            BaseHolder holder = new BaseHolder(context, itemView, parent, position);
