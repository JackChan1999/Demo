...
import com.qq.demo.utils.ResourceUtils;
...
public class DrawerScaleDrawable extends Drawable {
    ...
    public DrawerScaleDrawable(Context context) {
        ...
        this.mThemeColor = obtainStyledAttributes.getColor(R.styleable.Theme_mzThemeColor,
                resources.getColor(R.color.default_theme_color));
        obtainStyledAttributes.recycle();
        this.mDefaultColor = resources.getColor(R.color.drawerscaledrawable_default_color);
    ...
    public void draw(Canvas canvas) {
        ...
        for (i = 0; i < 3; i++) {
            /*????*/
            canvas.drawCircle(0, (float) i3, (float) i2, this.mPaintFill);
            canvas.drawCircle((float) ((int) (0 + (((float) this.mPathThickness) + lerp))), (float) i3, (float) i2, this.mPaintFill);
