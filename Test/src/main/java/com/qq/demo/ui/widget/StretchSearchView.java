...
public class StretchSearchView extends RelativeLayout {
    ...
    protected void initView(Context context) {
      /*  String str = "";
       ...
       mSearchLayout = (RelativeLayout) this.mSearchView.findViewById(R.id.mc_search_layout);
       mVoiceIcon = (ImageView) this.mSearchView.findViewById(R.id.mc_voice_icon);
       mImgSearch = (ImageView) this.mSearchView.findViewById(R.id.mc_search_icon);
       mImgSearchClear = (ImageView) this.mSearchView.findViewById(R.id
          .mc_search_icon_input_clear);
       mInputText = (SearchEditText) this.mSearchView.findViewById(R.id.mc_search_edit);
       mInputText.setAlpha(this.mSearchLayoutInitAlpha);
       mInputText.setHint(this.mSearchTextHint);
        if (this.mHasBtn) {
