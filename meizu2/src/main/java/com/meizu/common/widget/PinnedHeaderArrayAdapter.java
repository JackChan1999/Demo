...
public abstract class PinnedHeaderArrayAdapter<T> extends MultiArrayPartitionAdapter<T> implements PinnedHeaderAdapter {
    ...
    L_0x0039:
        ...
        goto L_0x0018;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meizu.common.widget.PinnedHeaderArrayAdapter.getPinnedHeaderView(int, android.view.View, android.view.ViewGroup):android.view.View");
    }
