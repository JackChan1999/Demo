...
import com.meizu.common.widget.SlidingMenu.OnClosedListener;
import com.meizu.common.widget.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    float distanceInfluenceForSnapDuration(float f) {
        return FloatMath.sin((float) (((double) (f - FastBlurParameters.DEFAULT_LEVEL)) * 0.4712389167638204d));
    }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        int min = Math.min((int) (((((float) Math.abs(i4)) / ((float) getBehindWidth())) + CircleProgressBar.BAR_WIDTH_DEF_DIP) * 100.0f), 300);
        if (this.mViewBehind.getVisibility() != 0) {
            this.mViewBehind.setVisibility(0);
        }
