...
public class TipDrawable extends BitmapDrawable {
    ...
    private void init(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.TipDrawable, R.attr.MeizuCommon_TipDrawableStyle, 0);
        this.mTipColor = obtainStyledAttributes.getColor(R.styleable.TipDrawable_mcTipColor, this.mContext.getResources().getColor(R.color.mc_tip_color));
        this.mRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TipDrawable_mcTipRadius, this.mContext.getResources().getDimensionPixelSize(R.dimen.mc_drawable_tip_radius));
