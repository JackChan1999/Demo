...
public class CircularAnimatedDrawable extends Drawable implements Animatable {
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        this.fBounds.left = (((float) rect.left) + (this.mBorderWidth / CircleProgressBar.BAR_WIDTH_DEF_DIP)) + FastBlurParameters.DEFAULT_LEVEL;
        this.fBounds.right = (((float) rect.right) - (this.mBorderWidth / CircleProgressBar.BAR_WIDTH_DEF_DIP)) - FastBlurParameters.DEFAULT_LEVEL;
        this.fBounds.top = (((float) rect.top) + (this.mBorderWidth / CircleProgressBar.BAR_WIDTH_DEF_DIP)) + FastBlurParameters.DEFAULT_LEVEL;
        this.fBounds.bottom = (((float) rect.bottom) - (this.mBorderWidth / CircleProgressBar.BAR_WIDTH_DEF_DIP)) - FastBlurParameters.DEFAULT_LEVEL;
    }
