...
public abstract class MzPushMessageReceiver extends BroadcastReceiver {
    ...
    private void parseMethodMessage(Context context, Intent intent, String str) {
        if ("message".equals(str)) {
            ...
            Log.i(TAG, " packageName " + context.getPackageName() + "receive through message " + stringExtra + " taskId " + intent.getStringExtra(PushConstants.EXTRA_APP_PUSH_TASK_ID));
            ...
            Log.i(TAG, "unable click message");
