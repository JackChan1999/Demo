...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList = new ArrayList(1);
        arrayList.add("BZ");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_HORIZ_TABLE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("GT");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_HORIZ_TABLE_SPLIT_LINE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("SV");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_AIR_TABLE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("HN");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_TRAIN_TABLE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("NI");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_CALLS_MESSAGE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("CR");
        ...
        arrayList = new ArrayList(1);
        arrayList.add("PM");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_BOTTOM_PARTID), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("HT");
        hashMap.put(Integer.valueOf(ViewPartId.PART_BODY_HORIZ_TABLE_POST), arrayList);
        arrayList = new ArrayList(3);
        arrayList.add("GP");
        arrayList.add("BL");
        arrayList.add("MF");
